...
threads. In particular, extent-local variables are intended
...
Programs are usually built from components that contribute independent,
...
Thread 2 has no database access permission, so `DBDriver`
